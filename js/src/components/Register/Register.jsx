 ...
 */}
                        ...
                        <br />
                        <br />
                        <button className='regbutton' disabled={!valid_Name || !validPwd || !validMatch || !validEmail || !validName || !validpNumber  ? true : false}><Link to="/login" className="no-underline" style={{textDecoration:'none', color:'white'}}>Sign Up</Link></button>
                        <p className="regp">
